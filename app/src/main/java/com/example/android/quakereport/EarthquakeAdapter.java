...
import static com.example.android.quakereport.R.id.magnitude_view;
...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        //Want to format magnitude to just show one number after the decimal point
        DecimalFormat formatter = new DecimalFormat("0.0");
        String magnitude = formatter.format(currentEarthquake.getMagnitude());

        TextView magnitudeTextView = (TextView) listItemView.findViewById(magnitude_view);
